...
public sealed class MarkMessageAsSeenCommandHandler(IUnitOfWork unitOfWork, IChatNotificationService notificationService) : IRequestHandler<MarkMessageAsSeenCommand>
{
      public async Task Handle(MarkMessageAsSeenCommand request, CancellationToken cancellationToken)
      {
            ...
            await notificationService.SendMessageSeenNotificationAsync(
